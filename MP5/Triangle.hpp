...
static const float EPLISON = 0.00001;

bool rayTriangleIntersect(const Vector3f& v0, const Vector3f& v1, const Vector3f& v2, const Vector3f& orig,
                          const Vector3f& dir, float& tnear, float& u, float& v)
{
    // v0, v1, v2 are triangle vertex
    // orig and dir are ray origin and direction
    // tnear is the parameter for hit point (origin + tnear * dir)
    // u and v are barycentric coordinates
    // origin + tnear * dir = (1-u-v)*v0 + u*v1 + v*v2
    ...
    // check if t >= 0 for ray
    // check b1, b2 >=0 and 1-b1-b2>=0 for inside triangle
